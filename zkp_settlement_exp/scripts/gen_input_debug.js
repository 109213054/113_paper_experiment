// Debug / handoff input generator
// Purpose:
// - fixed Settlement(1,1)
// - fixed small test cases
// - reproducible minimal runnable proof flow
// Supported modes:
//   receive, pay, zero, classify1, classify2
...
async function main() {
  ...
  const outDir = path.join("inputs", "generated", "debug", `phase3_msgfmt_1_1_${mode}`);
